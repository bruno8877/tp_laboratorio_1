 ...
 *
 */
int ll_set(LinkedList* this, int index,void* pElement)//agre
{
    int returnAux = -1;
    Node* auxNode;
    ...
    if(this != NULL && index >=0 && index < ll_len(this))
    {
        ...
        if(nuevoNodo!= NULL)
        {
            ...
            else
            {
                ...
                if(Anterior !=NULL)
                {
                    Anterior->pNextNode = nuevoNodo->pNextNode;//el Vagon anterior apunte al vagon siguiente
                    this->size--;
                    free(nuevoNodo);
                    returnAux =0;
 ...
 *
 */
int ll_clear(LinkedList* this)//elimina todos los elementos de la lista, queda como cuando hacemos el newLinkedList
{
    int returnAux = -1;
